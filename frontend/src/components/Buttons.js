...
function EditButton({ onClick, name }) {
  return (
...
function DeleteImageButton({ passportFile, onClick }) {
  return (
    <button
      ...
      } rounded outline outline-1 outline-gray-300 px-4 py-2 text-center text-red-500 self-end`}
      onClick={onClick}
    >
      {/* <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-10 w-10 fill-red-300"
        viewBox="0 0 20 20"
        fill="currentColor"
      >
        <path
